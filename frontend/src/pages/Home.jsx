        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 h-full">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-lg md:text-xl text-gray-600 mb-8 leading-relaxed font-light max-w-lg mx-auto lg:mx-0">
              ✨ “Reveal your inner glow with Inner Beauty Salon—specializing in Sisterlocks, Knotless Braids, luxury nails, and facials. Whether it’s a wedding, interview, or night out, our new Style Harmony AI designs the perfect look to match your outfit and occasion. Elevate your natural beauty with premium care that clients call a lifesaver.” ✨
            </p>
              ...
              <div className="absolute bottom-6 left-0 right-0 flex justify-center gap-2 z-20">
                {heroImages.map((_, idx) => (
                  <button
                    ...
                    className={`w-2.5 h-2.5 rounded-full transition-all ${idx === currentHeroIndex ? 'bg-white w-6' : 'bg-white/50'
                      }`}
                  />
                ))}
              </div>
